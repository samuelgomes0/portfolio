...
const skillsItems: SkillItem[] = [
  {
    category: 'Front-End',
    description: 'Construção de interfaces modernas, declarativas e escaláveis.',
    items: [
      {
        name: 'React',
  ...
  {
    category: 'Back-End',
    description: 'APIs seguras, performáticas e escaláveis com Node.js e TypeScript.',
    items: [
      {
        name: 'Node.js',
  ...
  },
  {
    ...
    description: 'Desenvolvimento de fluxos conversacionais inteligentes e automações.',
    items: [
      {
        name: 'Twilio Flex',
  ...
  },
  {
    ...
    description: 'Infraestrutura moderna, deploys eficientes e pipelines CI/CD.',
    items: [
      {
  ...
  },
  {
    ...
    description: 'Qualidade de código, versionamento e processos ágeis de desenvolvimento.',
    items: [
      {
        name: 'Clean Code',
